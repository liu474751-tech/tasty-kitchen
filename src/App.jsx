...
const RECIPES = [
  { id: 1, title: '番茄炒蛋', category: 'chinese', cuisine: 'lu', level: 0, time: '10 分钟', difficulty: '入门', calories: '180 千卡', image: 'https://image.pollinations.ai/prompt/Chinese%20tomato%20scrambled%20eggs%20in%20white%20bowl%20with%20chopsticks%20on%20wooden%20table%2C%20red%20tomatoes%20yellow%20fluffy%20eggs%2C%20garnished%20with%20green%20onion%2C%20food%20photography%2C%20appetizing%2C%204k?width=800&height=600&nologo=true', description: '国民家常菜。', ingredients: [{name: '鸡蛋', amount: 3, unit: '个'}], steps: ['炒鸡蛋', '炒番茄', '混合'] },
